package pl.ziolekmariusz.webstore.domain.repository.impl;
...
public class InMemoryProductRepository implements ProductRepository{
    ...
    public InMemoryProductRepository() {
        ...
        tablet_Nexus.setDescription("Google Nexus 7 is the lightest 7-inch tablet with quad-core Qualcomm Snapdragon S4 Pro processor");
